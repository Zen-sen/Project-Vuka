> **⚠️ HISTORICAL — April 30, 2026.** Many issues described here (fake Kronos inference, override mode, no learning) have been addressed. See `AGENT.md` and `Memory.md` for current state.
